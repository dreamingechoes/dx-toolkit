...
- Skills live in `.github/skills/<skill-name>/SKILL.md` (34+ skills across 10 domain categories)
...
- Reference checklists live in `.github/references/` (10 checklists)
...
- Hook configs live in `.github/hooks/*.json` (10 hooks)
